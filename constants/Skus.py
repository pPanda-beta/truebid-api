...
SKU_FLIGHT_NAME = 'Indigo Flight B2B'
SKU_FLIGHT_ID = 'Indigo Flight B2B'
SKU_FLIGHT_DESCRIPTION = 'Indigo Boeing 737 flight from New Delhi to Brussels. Accepting B2B bids.'
